...
$newPesanCount = Order::where('status', 'pending')->count();
...
<head>
  ...
  <link rel="icon" href="{{ asset('storage/logo/'.$konf->favicon_setting) }}">
  @if (Auth::user()->id == 1)
  ...
  <link rel="icon" type="image/png" href="{{asset ('storage/logo/'.$konf->logo_setting)}}" />
  <!-- Ionicons -->
  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="#" class="brand-link text-center">
        <span class="brand-text font-weight-light"><img src="{{ asset('storage/logo/'.$konf->logo_setting) }}" style="width: 120px; align: center" alt=""></span>
      </a>
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ route('produk.index') }}" class="nav-link d-flex justify-content-between align-items-center">
                <span>
                  <i class="fas fa-shopping-basket nav-icon"></i>
                  <span>Produk</span>
                </span>
                @livewire('stok-notification')
              </a>
            </li>

            <li class="nav-item">
              <a href="{{ route('transactions') }}" class="nav-link d-flex justify-content-between align-items-center">
                <span>
                  <i class="fas fa-cash-register nav-icon"></i>
                  <span> Transaksi</span>
                </span>
                @livewire('order-notification') <!-- Panggil komponen di sini -->
        ...
        @if (Auth::user()->id_kategori_petugas == 1)
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @elseif (Auth::user()->id_kategori_petugas == 2)
        <!-- Sidebar Menu -->
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
    ...
    <footer class="main-footer">
      <div class="float-right d-none d-sm-block">
        <img src="{{ asset('storage/logo/'.$konf->logo_setting) }}" style="width: 90px; height: 30px; align: center" alt="">
      </div>
      ...
      $('#kecamatan-dd').on('change', function() {
        ...
        $.ajax({
          ...
          success: function(result) {
            $('#kelurahan-dd').html('<option value="">Pilih Desa/ Kelurahan</option>');
            $.each(result.kelurahan, function(key, value) {
              $("#kelurahan-dd").append('<option value="' + value
                .id_kelurahan + '">' + value.nama_kelurahan + '</option>');
            });
